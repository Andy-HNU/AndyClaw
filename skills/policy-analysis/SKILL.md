...
```bash
python3 skills/policy-analysis/scripts/init_policy_kb.py --db memory/policy_knowledge.db
python3 skills/policy-analysis/scripts/write_policy_knowledge.py --db memory/policy_knowledge.db --input /tmp/sediment.json
```
